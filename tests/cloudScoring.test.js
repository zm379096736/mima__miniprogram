...
test('cloud scoring rollback reverses version two match points', () => {
  assert.equal(scoreAfterRollback(82, true, 2), 80);
  assert.equal(scoreAfterRollback(79, false, 2), 80);
});
